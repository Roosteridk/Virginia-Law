...
A. The Commission may adopt regulations prescribing required disclosures in connection with the offer or sale of any "security," as that term is defined in § [13.1-501](http://law.lis.virginia.gov/vacode/13.1-501/) of the Virginia Securities Act (§ [13.1-501](http://law.lis.virginia.gov/vacode/13.1-501/) et seq.), issued by any licensee organized under the laws of the Commonwealth.
