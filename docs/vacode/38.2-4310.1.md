...
A. A health maintenance organization shall make its initial deposit prior to licensure in an amount not less than $300,000. The Commission shall review a health maintenance organization's deposit requirement at least once each year and may require an additional deposit in an amount equal to the greater of (i) the sum of all uncovered expenses for the most recent three months reported in accordance with § [38.2-4307.1](http://law.lis.virginia.gov/vacode/38.2-4307.1/) B or (ii) the value of liabilities representing uncovered health care expenses.
...
2000, c. [503](http://lis.virginia.gov/cgi-bin/legp604.exe?001+ful+CHAP0503).
