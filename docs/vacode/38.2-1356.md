...
B. The Commission may, in addition to or in lieu of a penalty under § [38.2-218](http://law.lis.virginia.gov/vacode/38.2-218/), place on probation, suspend, revoke, or refuse to issue or renew a reinsurance intermediary's license for any one or more of the following causes:
