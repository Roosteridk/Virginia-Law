...
31. Assurances that the college partnership laboratory school (i) is nonreligious in its programs, admission policies, employment practices, and all other operations and (ii) does not charge tuition, except as described in subsection E of § [22.1-349.3](http://law.lis.virginia.gov/vacode/22.1-349.3/).
