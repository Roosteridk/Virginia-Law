...
A. If a creditor makes available to the debtors more than one plan of credit involuntary unemployment insurance as defined in § [38.2-122.1](http://law.lis.virginia.gov/vacode/38.2-122.1/), or more than one plan of credit property insurance as defined in § [38.2-122.2](http://law.lis.virginia.gov/vacode/38.2-122.2/), all debtors must be informed of all such plans for which they are eligible.
