...
5. The system shall include a stop sales alert, which shall be a notification that completion of the sale would result in the seller or purchaser violating the quantity limits set forth in § [18.2-265.7](http://law.lis.virginia.gov/vacode/18.2-265.7/), with an override function that may be used by a pharmacy or retail distributor under the circumstances set forth in § [18.2-265.9](http://law.lis.virginia.gov/vacode/18.2-265.9/) and shall record each instance in which the override function is utilized.
