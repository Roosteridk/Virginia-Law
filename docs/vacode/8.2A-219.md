...
(2) Subject to the provisions of this Title on the effect of default on risk of loss (§ [8.2A-220](http://law.lis.virginia.gov/vacode/8.2A-220/)), if risk of loss is to pass to the lessee and the time of passage is not stated, the following rules apply:
...
(c) In any case not within subdivision (a) or (b) of this subsection, the risk of loss passes to the lessee on the lessee's receipt of the goods if the lessor, or, in the case of a finance lease, the supplier, is a merchant; otherwise the risk passes to the lessee on tender of delivery.
