...
C. The Director's decision to approve, deny, revoke, or suspend a person's or facility's participation in any category of the Virginia Environmental Excellence Program is discretionary, shall not be a case decision as defined in § [2.2-4001](http://law.lis.virginia.gov/vacode/2.2-4001/), and shall be exempt from judicial review.
