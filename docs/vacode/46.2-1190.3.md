...
1. Have a current, valid driver's license, endorsed for motorcycle operation, that is neither suspended, revoked, cancelled, nor under probation, with less than six demerit points in a 12-month period and no conviction for any of the offenses enumerated in subsection E of § [18.2-270](http://law.lis.virginia.gov/vacode/18.2-270/);
