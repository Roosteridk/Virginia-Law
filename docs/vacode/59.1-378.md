...
6. Has constructed or caused to be constructed a racetrack or satellite facility for which a license was required under § [59.1-377](http://law.lis.virginia.gov/vacode/59.1-377/) hereof without obtaining such license, or has deviated substantially, without the permission of the Commission, from the plans and specifications submitted to the Commission; or
