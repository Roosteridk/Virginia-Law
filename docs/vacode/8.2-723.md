...
(1) If an action based on anticipatory repudiation comes to trial before the time for performance with respect to some or all of the goods, any damages based on market price (§ [8.2-708](http://law.lis.virginia.gov/vacode/8.2-708/) or § [8.2-713](http://law.lis.virginia.gov/vacode/8.2-713/)) shall be determined according to the price of such goods prevailing at the time when the aggrieved party learned of the repudiation.
