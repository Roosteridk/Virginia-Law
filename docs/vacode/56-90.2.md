...
c. However, if the acquired system is of a size that would qualify under the Small Water or Sewer Public Utility Act (§ [56-265.13:1](/vacode/56-265.13:1/) et seq.), such assets may be exempted from the requirement of performing a depreciation study.
...
Nothing in the established rules shall be construed to relieve the petitioners from the duty to demonstrate adequate service to the public at just and reasonable rates that will not be impaired or jeopardized by granting the prayer of the petition as provided in § [56-90](/vacode/56-90/).
