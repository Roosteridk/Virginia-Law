...
A. Except as otherwise provided by § [8.3A-308](http://law.lis.virginia.gov/vacode/8.3A-308/), when any pleading alleges that any person made, endorsed, assigned, or accepted any writing, no proof of the handwriting shall be required, unless it be denied by an affidavit accompanying the plea putting it in issue.
