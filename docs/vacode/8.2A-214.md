...
(1) Words or conduct relevant to the creation of an express warranty and words or conduct tending to negate or limit a warranty must be construed wherever reasonable as consistent with each other; but, subject to the provisions of § [8.2A-202](http://law.lis.virginia.gov/vacode/8.2A-202/) on parol or extrinsic evidence, negation or limitation is inoperative to the extent that the construction is unreasonable.
...
(4) To exclude or modify a warranty against interference or against infringement (§ [8.2A-211](http://law.lis.virginia.gov/vacode/8.2A-211/)) or any part of it, the language must be specific, be by a writing, and be conspicuous, unless the circumstances, including course of performance, course of dealing, or usage of trade, give the lessee reason to know that the goods are being leased subject to a claim or interest of any person.
