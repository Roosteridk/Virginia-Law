...
Benefits based on service in employment defined in subsection A of § [60.2-213](http://law.lis.virginia.gov/vacode/60.2-213/) shall be payable in the same amount on the same terms and subject to the same conditions as benefits payable on the basis of other service subject to this title, except that:
