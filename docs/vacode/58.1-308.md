...
If the understatement is false or fraudulent with intent to evade the tax, a penalty of 100 percent shall be added together with interest on the tax at a rate determined in accordance with § [58.1-15](http://law.lis.virginia.gov/vacode/58.1-15/), from the time the return was required by law to be filed until paid.
