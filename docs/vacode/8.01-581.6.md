...
2. In the event a hearing is held, the parties are entitled to be heard, to present relevant evidence, and to cross-examine witnesses to the extent necessary to enable the panel to render an opinion as specified in § [8.01-581.7](http://law.lis.virginia.gov/vacode/8.01-581.7/). The rules of evidence need not be observed. The medical review panel may proceed with the hearing and shall render an opinion upon the evidence produced, notwithstanding the failure of a party duly notified to appear.
