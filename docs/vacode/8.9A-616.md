...
(C) sent after disposition of the collateral under § [8.9A-610](http://law.lis.virginia.gov/vacode/8.9A-610/).

(b) Explanation of calculation. In a consumer-goods transaction in which the debtor is entitled to a surplus or a consumer obligor is liable for a deficiency under § [8.9A-615](http://law.lis.virginia.gov/vacode/8.9A-615/), the secured party shall:
