...
The written notification to the panel members shall include the definitions of "impartial attorney" and "impartial health care provider" as contained in § [8.01-581.1](http://law.lis.virginia.gov/vacode/8.01-581.1/) and a copy of the oath to which the panel members will be required to subscribe when the panel convenes. The oath shall be as follows:
