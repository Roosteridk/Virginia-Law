...
(a) If an accepted payment order is not, under subsection (a) of § [8.4A-202](http://law.lis.virginia.gov/vacode/8.4A-202/), an authorized order of a customer identified as sender, but is effective as an order of the customer pursuant to subsection (b) of § [8.4A-202](http://law.lis.virginia.gov/vacode/8.4A-202/), the following rules apply:
