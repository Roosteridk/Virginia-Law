...
D. Upon receipt of a request submitted in accordance with the requirements of subsection C, the Board shall conduct an analysis and evaluation of any proposed regulation based on the criteria enumerated in § [54.1-311](http://law.lis.virginia.gov/vacode/54.1-311/).
...
2016, c. [467](http://lis.virginia.gov/cgi-bin/legp604.exe?161+ful+CHAP0467).
