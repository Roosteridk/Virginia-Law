...
(3) Unless otherwise agreed and subject to the provisions of this title on C.I.F. contracts (subsection (3) of § [8.2-321](http://law.lis.virginia.gov/vacode/8.2-321/)), the buyer is not entitled to inspect the goods before payment of the price when the contract provides
