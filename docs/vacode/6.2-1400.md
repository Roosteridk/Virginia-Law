...
"Association" means a corporation organized as an industrial loan association under the provisions of the Virginia Stock Corporation Act (§ [13.1-601](http://law.lis.virginia.gov/vacode/13.1-601/) et seq.), the business of which is substantially confined to the business of making loans and issuing certificates of investment.
