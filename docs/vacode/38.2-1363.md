...
B. The Commission may, in addition to or in lieu of a penalty imposed under § [38.2-218](http://law.lis.virginia.gov/vacode/38.2-218/), place on probation, suspend, revoke or refuse to issue or renew any person's license as a managing general agent for any one or more of the following causes:
