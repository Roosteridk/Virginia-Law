...
B. The contingent assessment liability on any one policy in any one calendar year shall equal the premiums earned, as defined in § [38.2-1226](http://law.lis.virginia.gov/vacode/38.2-1226/), on the policy for that year multiplied by not less than one nor more than ten.
