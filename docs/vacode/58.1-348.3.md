...
3. Notwithstanding the provisions of § [58.1-3](/vacode/58.1-3/) or any other provision of this title, the Department is authorized to provide to the Internal Revenue Service and other state tax or revenue agencies for their confidential use preparer and return data, including PTIN information, taxpayer names, taxpayer identification numbers, and other information as necessary to enforce the provisions of this section and §§ [58.1-348.2](/vacode/58.1-348.2/) and [58.1-348.4](/vacode/58.1-348.4/).
