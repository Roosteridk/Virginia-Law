...
A. Every person who qualifies as a dealer under Chapter 8 (§ [29.1-800](http://law.lis.virginia.gov/vacode/29.1-800/) et seq.) of Title 29.1 and desires to transfer ownership in watercraft without obtaining a certificate of title shall file with the Tax Commissioner an application for a certificate of registration for each place of business in this Commonwealth.
